...
- the **dataset** you want to inspect: Single or double Sérsic mono band simulation, realistic morphologies (simulated with deep learning), or multiband data.  
   If you chose the latest, another button will appear to ask you which band you want to see the fitting.
- the **type of plot**: it will differ folowing the chosen dataset.  
...
- some sliders to control the **magnitude range** (x-axis) of the plots.  
